...
void BFS_host(pool P)
{
    ...
    *h_p_frontier_tail = 2;
    ...
    while (*h_p_frontier_tail > 0&&check==0) { 
        ...
        //CUDA_CHECK(cudaMemcpy(P.d_p_frontier_tail, P.d_c_frontier_tail, sizeof(int), cudaMemcpyDeviceToDevice));
        CUDA_CHECK(cudaMemcpy(P.h_visited, P.d_visited, (2*P.numVertex+1)*sizeof(int), cudaMemcpyDeviceToHost));
        //CUDA_CHECK(cudaMemset(P.d_c_frontier_tail, 0, sizeof(int))); 
